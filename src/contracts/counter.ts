...
type TonSmartTact_init_args = {
  $$type: 'TonSmartTact_init_args';
  id: bigint;
}

function initTonSmartTact_init_args(src: TonSmartTact_init_args) {
  return (builder: Builder) => {
      let b_0 = builder;
...
async function TonSmartTact_init(id: bigint) {
  const __code = Cell.fromBase64('');
  const __system = Cell.fromBase64('');
  let builder = beginCell();
  builder.storeRef(__system);
  builder.storeUint(0, 1);
  initTonSmartTact_init_args({ $$type: 'TonSmartTact_init_args', id })(builder);
  const __data = builder.endCell();
  return { code: __code, data: __data };
}

const TonSmartTact_errors: { [key: number]: { message: string } } = {
...
const TonSmartTact_types: ABIType[] = [
...
const TonSmartTact_getters: ABIGetter[] = [
...
const TonSmartTact_receivers: ABIReceiver[] = [
  {"receiver":"internal","message":{"kind":"typed","type":"Add"}},
  {"receiver":"internal","message":{"kind":"typed","type":"Deploy"}},
]

export class TonSmartTact implements Contract {
  
  static async init(id: bigint) {
      return await TonSmartTact_init(id);
  }
  
  static async fromInit(id: bigint) {
      const init = await TonSmartTact_init(id);
      const address = contractAddress(0, init);
      return new TonSmartTact(address, init);
  }
  
  static fromAddress(address: Address) {
      return new TonSmartTact(address);
  }
  
  readonly address: Address; 
  readonly init?: { code: Cell, data: Cell };
  readonly abi: ContractABI = {
      types:  TonSmartTact_types,
      getters: TonSmartTact_getters,
      receivers: TonSmartTact_receivers,
      errors: TonSmartTact_errors,
  };
